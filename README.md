...
2. 話題をクリックすると、新しい 3×3（9マス）が同じ色のまとまりで広がる。中央は元の話題のコピー、周囲が新しいキーワード。カードの 1A・2C は読み順（左→右、上→下。中央は E）。設定で放射にも切り替えられる
3. ピンした話題は画面上に大きく残る。展開したあとは、その親と新しいマスが画面の中央に来る。左下の − ＋ とホイール／ピンチで拡大。全体でマップ全体に合わせる
