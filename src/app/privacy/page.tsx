        ...
        <Section title="サーバーに送られるもの">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              ...
              に使われます。話題に ♡ を付けたり選んだり書き直したりしたときも、その話題の文言と回数を名前なしで記録します。お悩み相談・アイデア出しなど雑談以外のモードの内容も、モードごとに分けて同じように記録・公開されます。「具体的にする」で出た答えも同じように記録します。付箋の中身は記録しません。URL・メールアドレス・電話番号などを含む言葉は記録しません。
            </li>
            <li>
              「いっしょに見る」やテーマの公開：共有したボードとニックネームが保存され、URL を知っている人が見られます。
            </li>
            <li>
              みんなのトークテーマ：最初の話題からもう一歩広げたボードは、メモを外したカードの文言だけが名前なしで保存され、「みんなのトークテーマ」に載ることがあります。URL・メールアドレス・電話番号などを含むボードは載せません。
            </li>
            <li>
              配信一覧：配信 URL を貼った配信は、その配信のタイトル・チャンネル名・URL が一覧に載ります（配信が終わっても載ります）。
            </li>
          </ul>
