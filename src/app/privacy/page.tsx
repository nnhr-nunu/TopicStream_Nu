        ...
        <Section title="サーバーに送られるもの">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              ...
              に使われます。話題に ♡ を付けたり選んだり書き直したりしたときも、その話題の文言と回数を名前なしで記録します。お悩み相談・アイデア出しなど雑談以外のモードの内容も、モードごとに分けて同じように記録・公開されます。付箋の中身と「具体的にする」で出た答えの文は記録しません。URL・メールアドレス・電話番号などを含む言葉は記録しません。
            </li>
            <li>
